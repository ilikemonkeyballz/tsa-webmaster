...
export default function DirectoryPage() {
  ...
  const resources = [
    ...
    },
    {
      ...
      icon: "/icons/6 - meals on wheels.png",
    },
    {
      ...
      icon: "/icons/7 - habitat for humanity.png",
    },
    {
      id: 8,
    ...
    },
    {
      ...
      fees: "Free",
      icon: "/icons/9 - center for hope.png",
    },
        {
      id: 10,
      name: "Eva's Village",
      ...
      icon: "/icons/10 - eva's village.png",
    },
    {
      id: 11,
    ...
    },
    {
      ...
      fees: "Free",
      icon: "/icons/12 - ridgewood food.png",
    },
    {
      id: 13,
      ...
      icon: "/icons/13 - ridgewood soc serv.png",
    },
    {
      id: 14,
    ...
    },
    {
      ...
      fees: "Retail prices",
      icon: "/icons/18 - habitat for humanity.png",
    },
    {
      id: 19,
      ...
      icon: "/icons/19 - bergen new bridge.png",
  },
  {
      id: 20,
      ...
      eligibility: "All patients",
      fees: "Insurance / self-pay",
      icon: "/icons/20 - valley health.png",
  },
  {
    id: 21,
    ...
    eligibility: "All patients",
    fees: "Insurance / self-pay",
    icon: "/icons/21 - englewood health.png",
  },
  ...
  },
  {
    ...
    fees: "Free",
    icon: "/icons/23 - bc food security.png",
  },
  {
    id: 24,
    ...
    icon: "/icons/24 - vantage health.png",
  },

  {
    ...
    fees: "Free",
    icon: "/icons/25 - food brigade.png"
  },
  {
  id: 26,
  name: "ACAP Bergen County",
  category: "Senior Services",
  description: "Free educational programs, resources, and caregiver support for adult children caring for aging parents. Covers healthcare, legal, and financial planning topics.",
  town: "Paramus",
  address: "Paramus Library, 116 E Century Rd, Paramus, NJ 07652",
  phone: "(201) 677-8650",
  website: "https://acapcommunity.org/find-a-chapter/acap-bergen-county/",
  ...
  fees: "Free",
  icon: "/icons/26 - acap.png",
},
{
  id: 27,
  name: "Bergen County Dementia Friendly Initiative",
  category: "Senior Services",
  description: "Community initiative raising dementia awareness, reducing stigma, training professionals, and hosting free Memory Café events for those living with dementia and their care partners.",
  town: "Countywide",
  address: "Paramus Library, 116 E Century Rd, Paramus, NJ 07652",
  phone: "(201) 721-6721",
  website: "https://www.actnowfoundation.org/bergen-county-dementia-friendly-initiative",
  ...
  fees: "Free",
  icon: "/icons/27 - act now foundation.png",
},
{
  id: 28,
  name: "Glen Rock Senior Services",
  category: "Senior Services",
  description: "Municipal senior services including free community shuttle, discounted taxi coupons, health consultations, snow shoveling and leaf raking volunteers, homemaker services, and social programs.",
  town: "Glen Rock",
  address: "1 Harding Plaza, Glen Rock, NJ 07452",
  phone: "(201) 670-3956",
  website: "https://glenrocknj.net/resident/seniors",
  hours: "Mon–Fri 8:30am–4:30pm",
  eligibility: "Glen Rock senior residents",
  fees: "Free or discounted",
  icon: "/icons/28 - glen rock.png",
},
{
  id: 29,
  name: "Housing Authority of Bergen County (HABC)",
  category: "Housing",
  description: "Affordable housing programs for low-income families and older adults, including Housing Choice Vouchers, public housing buildings, emergency housing vouchers, and a Health & Human Services shelter.",
  town: "Hackensack / Countywide",
  address: "One Bergen County Plaza, 2nd Floor, Hackensack, NJ 07601",
  phone: "(201) 336-7600",
  website: "https://habcnj.org",
  hours: "Mon–Fri 8:30am–4:30pm",
  eligibility: "Low-income families, seniors, and individuals; income limits apply",
  fees: "Income-based rent",
  icon: "/icons/29 - habc.png",
},

{
  ...
  category: "Employment Services",
  description: "Free job search assistance, resume writing, interview prep, occupational training grants, GED preparation, and specialized support for veterans, youth, people with disabilities, and justice-involved individuals.",
  town: "Hackensack",
  address: "60 State Street, Hackensack, NJ 07601",
  phone: "(201) 329-9600",
  website: "https://bergenjobcenter.com",
  ...
  fees: "Free",
  icon: "/icons/30 - bc job center.png",
},

{
  id: 31,
  name: "Project SEARCH – North Jersey Friendship House",
  category: "Disability Services",
  description: "10-month business-led internship program for adults with disabilities (ages 18–30), providing real workplace skill-building through three rotations with a 90% graduate employment rate.",
  town: "Oradell",
  address: "496 Kinderkamack Road, Oradell, NJ 07649",
  phone: "(201) 488-2121",
  website: "https://njfriendshiphouse.org/programs-services/project-search/",
  ...
  icon: "/icons/31 - project search.png",
},
  ];
