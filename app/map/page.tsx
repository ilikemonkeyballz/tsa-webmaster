...
const MAP_RESOURCES = [
  { id: 1, name: "Center for Food Action (CFA)", category: "Food & Social Services", address: "316 First St, Hackensack, NJ", phone: "(201) 883-9375", website: "https://cfanj.org", hours: "By appointment; varies by site", fees: "Free", lat: 40.8860, lng: -74.0435, icon: "🍎" },
  { id: 2, name: "Family Promise of Bergen County", category: "Shelter & Housing", address: "100 Dayton St, Ridgewood, NJ", phone: "(201) 833-8009", website: "https://www.bergenfamilypromise.org", hours: "Dinner daily 4:45–5:50pm", fees: "Free", lat: 40.9793, lng: -74.1151, icon: "🏠" },
  { id: 3, name: "Greater Bergen Community Action", category: "Community Services", address: "392 Main Street, Hackensack, NJ", phone: "(201) 968-0200", website: "https://www.greaterbergen.org", hours: "Mon–Fri 9am–5pm", fees: "Free or income-based", lat: 40.8876, lng: -74.0431, icon: "🤝" },
  { id: 4, name: "Bergen Volunteers", category: "Volunteer Services", address: "64 Passaic St, Hackensack, NJ", phone: "(201) 489-9696", website: "https://bergenvolunteers.org", hours: "Contact for availability", fees: "Free", lat: 40.8858, lng: -74.0467, icon: "🙋" },
  { id: 5, name: "Jewish Family & Children's Services", category: "Social Services", address: "1485 Teaneck Rd, Teaneck, NJ", phone: "(201) 837-9090", website: "https://www.jfcsnnj.org", hours: "Varies by program", fees: "Sliding scale", lat: 40.8887, lng: -74.0143, icon: "💙" },
  { id: 7, name: "Habitat for Humanity Bergen & Passaic", category: "Housing", address: "121 Carver Ave, Westwood, NJ", phone: "(201) 457-1020", website: "https://www.habitatbergen.org", hours: "Office hours vary", fees: "Affordable mortgage model", lat: 41.0026, lng: -74.0310, icon: "🔨" },
  { id: 9, name: "Center for Hope & Safety", category: "Domestic Violence Services", address: "10-12 Fair Lawn Ave, Fair Lawn, NJ", phone: "(201) 794-8894", website: "https://www.hopeandsafetynj.org", hours: "24/7 crisis line", fees: "Free", lat: 40.9401, lng: -74.1179, icon: "🛡️" },
  { id: 10, name: "Eva's Village", category: "Homeless Services", address: "393 Main St, Paterson, NJ", phone: "(973) 523-6220", website: "https://www.evasvillage.org", hours: "Hours vary by service", fees: "Free or subsidized", lat: 40.9176, lng: -74.1719, icon: "🏚️" },
  { id: 15, name: "Goodwill NY/NJ", category: "Employment Services", address: "700 Paramus Park, Paramus, NJ", phone: "Contact via website", website: "https://www.goodwillnynj.org", hours: "Varies by location", fees: "Often free", lat: 40.9448, lng: -74.0706, icon: "💼" },
  { id: 16, name: "YWCA Northern New Jersey", category: "Childcare & Support", address: "214 State Street, Hackensack, NJ", phone: "(201) 881-1700", website: "https://ywcannj.org", hours: "Office hours vary by program", fees: "Varies", lat: 40.8878, lng: -74.0445, icon: "👶" },
  { id: 19, name: "Bergen New Bridge Medical Center", category: "Community Services", address: "230 E Ridgewood Ave, Paramus, NJ", phone: "(201) 967-4000", website: "https://www.newbridgehealth.org", hours: "24/7 emergency", fees: "Insurance / self-pay", lat: 40.9600, lng: -74.0730, icon: "🏥" },
  { id: 20, name: "Valley Hospital", category: "Community Services", address: "4 Valley Health Plaza, Paramus, NJ", phone: "(201) 447-8000", website: "https://www.valleyhealth.com", hours: "24/7", fees: "Insurance / self-pay", lat: 40.9512, lng: -74.0693, icon: "🏥" },
  { id: 21, name: "Englewood Health", category: "Community Services", address: "350 Engle St, Englewood, NJ", phone: "(201) 894-3000", website: "https://www.englewoodhealth.org", hours: "24/7", fees: "Insurance / self-pay", lat: 40.8934, lng: -73.9726, icon: "🏥" },
  { id: 22, name: "CarePlus NJ", category: "Community Services", address: "610 Valley Health Plaza, Paramus, NJ", phone: "(201) 265-8200", website: "https://www.careplusnj.org", hours: "Varies by clinic", fees: "Insurance / sliding scale", lat: 40.9448, lng: -74.0740, icon: "🧠" },
  { id: 24, name: "Vantage Health System", category: "Community Services", address: "93 W Palisade Ave, Englewood, NJ", phone: "(201) 567-0059", website: "https://www.vantagenj.org", hours: "Mon–Fri 8:30am–5pm", fees: "Medicaid / sliding scale", lat: 40.8929, lng: -73.9737, icon: "🧠" },
  { id: 25, name: "The Food Brigade", category: "Food & Social Services", address: "185 W Madison Ave, Dumont, NJ", phone: "(201) 614-4414", website: "https://foodbrigade.org", hours: "By appointment only", fees: "Free", lat: 40.9437, lng: -73.9957, icon: "🥫" },
  { id: 26, name: "ACAP Bergen County", category: "Senior Services", address: "116 E Century Rd, Paramus, NJ", phone: "(201) 677-8650", website: "https://acapcommunity.org", hours: "2nd Monday monthly at 6pm", fees: "Free", lat: 40.9443, lng: -74.0742, icon: "👴" },
  { id: 29, name: "Housing Authority of Bergen County", category: "Housing", address: "1 Bergen County Plaza, Hackensack, NJ", phone: "(201) 336-7600", website: "https://habcnj.org", hours: "Mon–Fri 8:30am–4:30pm", fees: "Income-based rent", lat: 40.8837, lng: -74.0416, icon: "🏠" },
  { id: 30, name: "Bergen County Job Center", category: "Employment Services", address: "60 State Street, Hackensack, NJ", phone: "(201) 329-9600", website: "https://bergenjobcenter.com", hours: "Mon–Fri 8am–4:30pm", fees: "Free", lat: 40.8891, lng: -74.0408, icon: "💼" },
  { id: 31, name: "Project SEARCH – Friendship House", category: "Disability Services", address: "496 Kinderkamack Rd, Oradell, NJ", phone: "(201) 488-2121", website: "https://njfriendshiphouse.org", hours: "Contact for schedule", fees: "DDD-funded or self-pay", lat: 40.9554, lng: -74.0363, icon: "♿" },
];
