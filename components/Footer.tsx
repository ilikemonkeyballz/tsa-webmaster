      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold mb-4 italic text-seafoam">Community Hub</h3>
          ...
          <div>
            ...
            <ul className="space-y-3 text-mint/80">
              <li>Email: info@communityhub.org</li>
        ...
        <div className="border-t border-forest-medium mt-12 pt-8 text-center text-mint/70">
          <p>&copy; 2026 Community Resource Hub. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
